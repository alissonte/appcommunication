...
public class CommunicationServiceTest {
    ...
    public void givenInvalidParameters_WhenProcess_thenThrowsException() {
        ...
        //When
        final Exception exception = assertThrows(CommunicationParamsException.class, () -> communicationService.saveScheduleCommunication(communicationDTO));
    ...
    public void givenCommunicationIdValid_WhenProcess_theReturnCommunicationValid() {
        ...
        //When
        final CommunicationDTO result = communicationService.findCommunicationById(id);
    ...
    public void givenCommunicationWithIdInvalid_WhenProcess_throwsException() {
        ...
        //When
        final Exception exception = assertThrows(EntityNotFoundException.class, () -> communicationService.findCommunicationById(id));
    ...
    public void givenParamCancelAndId_WhenProcess_thenCancelCommunication() {
        ...
        //When
        final CommunicationDTO result = communicationService.cancelCommunication(id);

        //Then
        assertEquals(result.getStatus(), communicationDTO.getStatus());
    }

    private List<CommunicationDTO> getCommunicationsDTOs(final List<Communication> communications) {
